...
save(count_data, col_data, file = "data/processed/breast_cancer_loaded_data.RData")
cat("Breast cancer simulated data loaded and saved successfully.\n")

# Optional: Verify the data
cat("\nFirst few rows of count data:\n")
print(head(count_data[, 1:4]))
cat("\nSummary of counts:\n")
print(summary(rowSums(count_data)))